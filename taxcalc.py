...
def taxfunc():                                                                    # function to calculate yearly tax
    ...
    month = float(''.join(filter(str.isdigit, monthly)))                          # filter usable var from user input
    taxfrac = float(''.join(filter(str.isdigit, tax)))                            # filter usable var from user input
